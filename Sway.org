...
#+PROPERTY: header-args :tangle ./stow-home/.config/sway/config
...
* Wallpaper
#+begin_src conf
output eDP-1 mode 1920x1200 bg /home/jrrom/dotfiles/wallpapers/blue-lake-1920x1200.png fill
#+end_src
* EWW Daemon
#+begin_src conf
exec eww daemon
#+end_src
* Keybindings
Note: I do not use the Sway scratchpad.
** Basics
#+begin_src conf
# Start main program
bindsym $mod+Return exec $main

# Kill focused window
bindsym $mod+Shift+q kill

# Start your launcher
bindsym $mod+d exec eww open launcher --toggle

# Increment launcher
# bindsym $mod+Ctrl+n exec ~/dotfiles/scripts/next.clj
...
seat seat0 xcursor_theme Bibata-Modern-Ice 32
